...
func HitEnemy(host_l string, minerPort_l string, buf *[]byte) {
	...
	if err != nil {
		*buf = output.MakeJSONError("enemy", err)
	}
	...
	js, err := output.MakeJSON_full("enemy", hrtotal, hrstring, numMiners, totalPower)
	if err != nil {
		*buf = output.MakeJSONError("enemy", err)
		return
	}
